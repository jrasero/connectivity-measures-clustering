...
% Iterate through bands
 for iband=1:n_bands
    ...
    for iroi=1:n_rois
        ...
        mkdir(strcat('/home/javi/Documentos/measures_clustering_daniele/clustering/roi_34/',... 
            roi), band)
        output_dir = strcat('/home/javi/Documentos/measures_clustering_daniele/clustering/roi_34/',...
            roi, "/", band);
        R_rec = zeros(n_recs, n_measures*n_funcs, n_measures*n_funcs);
        
        for irec=1:n_recs
            load(strcat('similarity_matrices/roi_34', "/",...
                roi, "/", band, "/",  ...
