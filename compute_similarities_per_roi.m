...
disp(['Doing ROI:' ' ' roi])
  ...
  for iband=1:n_bands
      ...
      mkdir(strcat('/home/javi/Documentos/measures_clustering_daniele/similarity_matrices/roi_34/',... 
          roi), band)

      output_dir = strcat('/home/javi/Documentos/measures_clustering_daniele/similarity_matrices_roi/roi_34/',...
           roi, "/", band);
